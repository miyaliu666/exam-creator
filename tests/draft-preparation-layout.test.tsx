...
function render(candidatesFirst: boolean, requirementsNeedAttention = false) {
  return renderToStaticMarkup(<ChakraProvider value={defaultSystem}><DraftPreparationLayout
    candidatesFirst={candidatesFirst} requirementsNeedAttention={requirementsNeedAttention}
...
test("ready candidates come before optional requirements and regeneration controls", () => {
