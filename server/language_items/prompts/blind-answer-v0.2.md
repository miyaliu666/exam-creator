...
Write reasoning and limitations in English for the author. Preserve option, response, field and turn IDs exactly; write attempted open responses in the language required by the visible task. Copy evidence quotes in their original language without translating them.
