# R-A1-1 Single Select Generation Prompt v0.3
...
- Set `candidatePayload.shuffleOptions` to `false`. Option order is part of the reviewed item and must remain fixed.
