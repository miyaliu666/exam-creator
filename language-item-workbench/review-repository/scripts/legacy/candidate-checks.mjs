...
import { exerciseType, validateExerciseCandidate } from './exercise-template-checks.mjs';
...
export function validateCandidate(pkg, registry) {
  ...
  if (exerciseType(pkg)) { validateExerciseCandidate(pkg, registry); return; }
  let responseIds = [];
