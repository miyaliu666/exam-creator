...
| Item rules | One allowed Blueprint slot × Item format × Primary Can-do combination and its rules. |
| Item setup | The six selections for an item: Blueprint slot, Item format, Primary Can-do, Domain, Context, and Difficulty. |
...
1. **Blueprint slot, Item format, and exactly one Primary Can-do**: Selects the measurement target from published Item rules. Skill/activity are derived, and Task family/scoring/delivery rules are locked to the selected configuration.
