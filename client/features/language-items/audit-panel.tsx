...
const ACTION_LABELS: Record<string, string> = {
  ...
  "draft.validated": "Item checks run",
  "version.frozen": "Review snapshot created",
  "version.revision.started": "Revision draft created",
  "ai.generation.completed": "AI drafts generated",
  "ai.generation.failed": "AI draft generation failed",
  "ai.candidate.adopted": "AI draft adopted",
  "ai.review.completed": "Version AI feedback completed",
  "ai.review.failed": "Version AI feedback failed",
  "ai.review.draft.completed": "Draft AI feedback completed",
  "ai.review.draft.failed": "Draft AI feedback failed",
